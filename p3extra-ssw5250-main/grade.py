...
point_breakdown = [
    ...
    (1, ["channel_test_stress_send_recv_unbuffered"]),
    (1, ["sanitize_test_stress_send_recv_unbuffered"]),
    (1, ["valgrind_test_stress_send_recv_unbuffered"]),

    # Unbuffered select (extra credit 27 pts)
    ...
    (1, ["channel_test_stress_mixed_buffered_unbuffered"]),
    (1, ["sanitize_test_stress_mixed_buffered_unbuffered"]),
    (1, ["valgrind_test_stress_mixed_buffered_unbuffered"]),
]
